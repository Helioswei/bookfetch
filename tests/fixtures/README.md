# Fixtures — source & capture info

Real page/structure samples captured for offline parsing tests. All are tiny
structural excerpts from public sources, used for parser testing only:

| file | source | captured | content |
|---|---|---|---|
| searchbooks.html | https://ctext.org/searchbooks.pl?if=gb&searchu=渊海子平 | 2026-09-03 | ctext 書名檢索 result page (11KB) |
