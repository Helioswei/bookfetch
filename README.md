...
<p align="center"><img src="docs/screenshots/bookfetch-demo.gif" width="720" alt="bookfetch 演示：搜索《明朝那些事儿》→ 下载 → 书架 → 阅读（2x 快进）"></p>
...
详细版本历史见 [CHANGELOG.md](CHANGELOG.md)，**当前版本见文首 PyPI 徽章**（发布即自动更新）。bookfetch 自 **v1.0.0**（2026-09-05）起为稳定对外版；0.x 开发期（2026-09-03 ~ 09-05）已完结。
